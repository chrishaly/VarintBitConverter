...
namespace VarintBitConverter.UnitTests
{
    public class VarintBitConverterTest
    {
        ...
        public void VarintEncodeAndDecodeInt16MaxValue()
        {
            ...
            var encoded = System.VarintBitConverter.GetVarintBytes(number);
            Assert.Equal(number, System.VarintBitConverter.ToInt16(encoded));
        }
        ...
        public void VarintEncodeAndDecodeUInt16MaxValue()
        {
            ...
            var encoded = System.VarintBitConverter.GetVarintBytes(number);
            Assert.Equal(number, System.VarintBitConverter.ToUInt16(encoded));
        }
        ...
        public void VarintEncodeAndDecodeInt32MaxValue()
        {
            ...
            var encoded = System.VarintBitConverter.GetVarintBytes(number);
            Assert.Equal(number, System.VarintBitConverter.ToInt32(encoded));
        }
        ...
        public void VarintEncodeAndDecodeUInt32MaxValue()
        {
            ...
            var encoded = System.VarintBitConverter.GetVarintBytes(number);
            Assert.Equal(number, System.VarintBitConverter.ToUInt32(encoded));
        }
        ...
        public void VarintEncodeAndDecodeInt64MaxValue()
        {
            ...
            var encoded = System.VarintBitConverter.GetVarintBytes(number);
            Assert.Equal(number, System.VarintBitConverter.ToInt64(encoded));
        }
